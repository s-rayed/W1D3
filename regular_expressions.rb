...
def grab_sin(string)
  search = string.match(/\d{3}-\d{3}-\d{3}/)
    return search.to_s if search
end


# puts "grab_sin returns an SIN if the string has an SIN"
# p grab_sin("please don't share this: 234-604-142") == "234-604-142"

# puts "grab_sin returns nil if it doesn't have a SIN"
# p grab_sin("please confirm your identity: XXX-XXX-142") == nil
